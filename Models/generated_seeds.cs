...
namespace PowerBIPoC.Data
{
  public static class PowerBIPoCContextSeeds
  {
        static Func<System.Collections.Generic.Dictionary<int, HomePage>> seed_HomePages = null;
    static HomePage[] HomePages = null;
     static Func<System.Collections.Generic.Dictionary<int, Admin>> seed_Admins = null;
    static Admin[] Admins = null;
     static Func<System.Collections.Generic.Dictionary<int, BIDiagram>> seed_BIDiagrams = null;
    static BIDiagram[] BIDiagrams = null;
    ...
    public static void Initialize(PowerBIPoCContext context)
    {
      ...
      seed_HomePages = () => {
        ...
        if (!context.HomePage.Any())
        {
            ...
            _HomePage.Add(0, new HomePage { CreatedDate = DateTime.Now,   });
      ...
      seed_Admins = () => {
        ...
        if (!context.Admin.Any())
        {
            ...
            _Admin.Add(1, new Admin { CreatedDate = DateTime.Now, Username = "hoppinger", Language = "en", Email = "info@hoppinger.com",  PasswordHash = password.PasswordHash, PasswordSalt = password.PasswordSalt });
