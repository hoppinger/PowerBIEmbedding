...
[Route("/admin/[controller]")]
  public partial class BIDiagramsController : Controller
  {
    public readonly PowerBIPoCContext _context;
    public IHostingEnvironment env;
    private readonly ProjectNameOptions _projectNameOptions;

    public BIDiagramsController(PowerBIPoCContext context, IHostingEnvironment env, IOptions<ProjectNameOptions> projectNameOptions)
    {
      _context = context;
